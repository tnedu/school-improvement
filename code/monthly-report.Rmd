  ...
  pmap(
    ...
    .f = ~ ..1 %>%
      ...
      scale_y_continuous(
        ...
        limits = c(0, 100) # 1.1 * max(..1[[..3]], na.rm = T))
      ) +
      scale_color_manual(values = c("gray", ..5)) +
      theme_minimal() +
      theme(
...
table_school <-
  pmap(
    .l = list(
      ...
      fill_colors_low = c(rep("blue", 2), "deeppink3"),
      fill_colors_high = c("red", "orange", "purple"),
      ...
      labs(
        ...
        caption = str_wrap(
          str_c("School ranks show where schools stand among all 92 CSI schools ",
                "(1 corresponds to the lowest percent, 92 corresponds to the ",
                "highest). The 2018-19 Year-to-Date column ",
